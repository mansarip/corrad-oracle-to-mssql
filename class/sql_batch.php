...
//============================================ menu =================================================
	...
	public function getMenuList($parentId = '', $permissionFlag = true, $publicFlag = false)
	{
		//root menu
		...
		$getMenuListRs = $this->query($getMenuList, 'SELECT', 'NAME');
		...
		for($x=0; $x<$getMenuListRsCount; $x++)
		{
			...
			$getMenuListRs[$x]['MENUCHILD'] = $this->getMenuList($getMenuListRs[$x]['MENUID'], $permissionFlag, $publicFlag);
		}//eof for
	...
	public function getMenuIdByMenuParent($menuId, $includeParent = true)
	{
		...
		if($menuId)
		{
			...
			$getMenuIdRs = $this->query($getMenuId);
	...
	public function deleteMenu($menuId)
	{
		...
		if($menuId)
		{
			...
			$deleteMenuRs = $this->query($deleteMenu,'RUN');
...
//============================================ page =================================================
	...
	public function getPageIdByMenuId($menuId)
	{
		...
		if($menuId)
		{
			...
			$getPageIdRs = $this->query($getPageId);
	...
	public function duplicatePage($fromPage, $toMenu)
	{
		...
		if($fromPage && $toMenu)
		{
			...
			$duplicatePageRs = $this->query($duplicatePage,'RUN');
	...
	public function deletePage($pageId)
	{
		...
		if($pageId)
		{
			...
			$deletePageRs = $this->query($deletePage,'RUN');
...
//========================================= component ===============================================
	...
	public function getComponentIdByPageId($pageId)
	{
		...
		if($pageId)
		{
			...
			$getComponentIdRs = $this->query($getComponentId);
	...
	public function duplicateComponent($fromComponent, $toPage)
	{
		...
		if($fromComponent && $toPage)
		{
			...
			$duplicateComponentRs = $this->query($duplicateComponent,'RUN');
	...
	public function deleteComponent($componentId)
	{
		...
		if($componentId)
		{
			...
			$deleteComponentRs = $this->query($deleteComponent,'RUN');
...
//============================================ item =================================================
	...
	public function getItemIdByComponentId($componentId)
	{
		...
		if($componentId)
		{
			...
			$getItemIdRs = $this->query($getItemId);
	...
	public function duplicateItem($fromItem, $toComponent='')
	{
		...
		if($fromItem)
		{
			...
			$duplicateItemRs = $this->query($duplicateItem,'RUN');
	...
	public function deleteItem($itemId)
	{
		...
		if($itemId)
		{
			...
			$deleteItemRs = $this->query($deleteItem,'RUN');
...
//=========================================== chart =================================================
	...
	public function duplicateChart($fromItem, $toItem)
	{
		...
		if($fromItem && $toItem)
		{
			...
			$duplicateChartRs = $this->query($duplicateChart,'RUN');
		}//eof if
	...
	public function deleteChart($itemId)
	{
		...
		if($itemId)
		{
			...
			$deleteChartRs = $this->query($deleteChart,'RUN');
		}//eof if
...
//========================================== control ================================================
	...
	public function getControlIdByPageId($pageId)
	{
		...
		if($pageId)
		{
			...
			$getControlIdRs = $this->query($getControlId);
	...
	public function duplicateControl($fromControl, $toPage, $toComponent='')
	{
		...
		if($fromControl && $toPage)
		{
			...
			$duplicateControlRs = $this->query($duplicateControl,'RUN');
	...
	public function deleteControl($controlId)
	{
		...
		if($controlId)
		{
			...
			$deleteControlRs = $this->query($deleteControl,'RUN');
...
//========================================== trigger ================================================
	...
	public function getTriggerId($itemType, $itemId)
	{
		...
		if($itemType && $itemId)
		{
			...
			$getTriggerIdRs = $this->query($getTriggerId);
	...
	public function duplicateTrigger($fromTrigger, $toItem)
	{
		...
		if($fromTrigger && $toItem)
		{
			...
			$duplicateTriggerRs = $this->query($duplicateTrigger,'RUN');
			...
			if($duplicateTriggerRs)
			{
				...
				$duplicateTriggerParameter = "insert into FLC_TRIGGER_PARAMETER (TRIGGER_ID, PARAMETER_SEQ, PARAMETER_VALUE)
												...
												where TRIGGER_ID = ".$fromTrigger;
				$duplicateTriggerParameterRs = $this->query($duplicateTriggerParameter,'RUN');
			}//eof if
		}//eof if
	...
	public function deleteTrigger($triggerId)
	{
		...
		if($triggerId)
		{
			...
			$deleteTriggerRs = $this->query($deleteTrigger,'RUN');
			...
			if($deleteTriggerRs)
			{
				...
				$deleteTriggerParameterRs = $this->query($deleteTriggerParameter,'RUN');
			}//eof if
		}//eof if
...
//======================================== permission ===============================================
	...
	public function getPermissionSQL($itemType, $userId)
	{
	...
	public function duplicatePermission($itemType, $fromItem, $toItem)
	{
		...
		if($itemType && $fromItem && $toItem)
		{
			...
			$duplicatePermissionRs = $this->query($duplicatePermission,'RUN');
		}//eof if
	...
	public function deletePermission($itemType, $itemId)
	{
		...
		if($itemId)
		{
			...
			$deletePermissionRs = $this->query($deletePermission,'RUN');
		}//eof if
